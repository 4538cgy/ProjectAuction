...
import com.example.project_auction.databinding.ActivityAuctionSuccessHistoryBinding

class AuctionSuccessHistoryActivity : BaseActivity<ActivityAuctionSuccessHistoryBinding>(R.layout.activity_auction_success_history) {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding.apply {
            activityauctionsuccesshistory = this@AuctionSuccessHistoryActivity
        }

        setSupportActionBar(binding.activityAuctionSuccessHistoryToolbarTitle)
        ...
        val dividerItemDecoration =
            DividerItemDecoration(
                binding.activityAuctionSuccessHistoryRecyclerviewItem.context,
                LinearLayoutManager(this).orientation
            )
        binding.activityAuctionSuccessHistoryRecyclerviewItem.addItemDecoration(dividerItemDecoration)

        val adpater = MultiViewTypeAdapter(list)
        binding.activityAuctionSuccessHistoryRecyclerviewItem.layoutManager = LinearLayoutManager(this, RecyclerView.VERTICAL, false)
        ...
        binding.activityAuctionSuccessHistoryRecyclerviewItem.adapter = adpater
    }
