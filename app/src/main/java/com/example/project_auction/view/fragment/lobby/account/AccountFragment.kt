...
class AccountFragment : BaseFragment<FragmentAccountBinding>(R.layout.fragment_account) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            fragment_account_textview_nickname.setOnClickListener {
                ...
                val dialogText =
                    dialogView.findViewById<EditText>(R.id.alertdialog_edittext_nickname)
                ...
                builder.setView(dialogView)
                    .setPositiveButton("확인") { dialogInterface, i ->
                        ...
                        fragment_account_textview_nickname.text =
                            dialogText.text.toString().replace(" ", "")
                    }
            ...
            fragmentAccountButtonAuctionJoinHistory.setOnClickListener {
                val intent = Intent(requireContext(), AuctionJoinHistoryActivity::class.java)
                startActivity(intent)
            }
    ...
    private fun getProfileImage() {
        db.collection("UserProfileImages").document(auth.currentUser!!.uid).get()
