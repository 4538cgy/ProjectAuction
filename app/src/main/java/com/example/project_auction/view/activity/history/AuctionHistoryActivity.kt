...
import com.example.project_auction.databinding.ActivityAuctionHistoryBinding

class AuctionHistoryActivity : BaseActivity<ActivityAuctionHistoryBinding>(R.layout.activity_auction_history) {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding.apply {
            activityauctionhistory = this@AuctionHistoryActivity
        }

        setSupportActionBar(binding.activityAuctionHistoryToolbarTitle)
        ...
        val dividerItemDecoration =
            DividerItemDecoration(
                binding.activityAuctionHistoryRecyclerviewItem.context,
                LinearLayoutManager(this).orientation
            )
        binding.activityAuctionHistoryRecyclerviewItem.addItemDecoration(dividerItemDecoration)

        val adpater = MultiViewTypeAdapter(list)
        binding.activityAuctionHistoryRecyclerviewItem.layoutManager = LinearLayoutManager(this, RecyclerView.VERTICAL, false)
        ...
        binding.activityAuctionHistoryRecyclerviewItem.adapter = adpater
    }
